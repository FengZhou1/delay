...
% The new timings (RTS=14.5, SIFS=16, DIFS=34, CTS=14.5) are NOT integer
...
% Derived values (n_sectors=8): CTS sweep = 116.0 us, conn-slot = 162.5 us,
% CTS timeout = 132.0 us, DATA = M * conn-slot.
    ...
    timing.CTS_SWEEP_US = n_sectors * timing.CTS_US;               % 116.0
    timing.CONN_SLOT_US = timing.RTS_US + timing.SIFS_US + ...
        timing.CTS_SWEEP_US + timing.SIFS_US;                     % 162.5
    timing.CTS_TIMEOUT_US = timing.SIFS_US + timing.CTS_SWEEP_US; % 132.0
