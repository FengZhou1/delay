...
%   All packets in the TXOP are transmitted.  A packet is counted as failed
%   only when its own airtime overlaps an interference interval.  Succeeding
%   later packets are not discarded merely because an earlier packet failed.
